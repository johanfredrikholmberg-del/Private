...
export const KAU_PROGRAM_DB={
  ...
  SGBET:{
    name:'Beteendevetenskapligt program',totalHp:180,sourceUrl:'https://www.kau.se/utbildning/program-och-kurser/program/SGBET',verifiedAt:'2026-09-13',
    courses:[
      row(1,'Introduktion till socialpsykologi',7.5),row(1,'Introduktion till sociologin',7.5),row(1,'Introduktion till psykologi',7.5),row(1,'Introduktion till vetenskaplig metod',7.5),
      row(2,'Socialpsykologisk teori',7.5),row(2,'Sociologisk teori',7.5),row(2,'Fortsättningskurs vetenskaplig metod',7.5),row(2,'Projektarbete i sociologi',7.5),
      row(3,'Utvecklingspsykologi och personlighet',7.5),row(3,'Psykologiska perspektiv på ledarskap',7.5),row(3,'Organisation, projektledning och grupprocesser',7.5),row(3,'Genusperspektiv och jämställdhetsarbete',7.5),
      row(4,'Digitala medier, makt och vardagsliv',7.5),row(4,'Emotioner, intimitet och personligt liv',7.5),row(4,'Samhällsförändring med fokus på ålder och migration',7.5),row(4,'Plats, livsvillkor och tillhörighet',7.5),
      slot(5,30,[['Praktik (hel termin): beteendevetenskap',30],['Valfri kurs',30],['Praktik (halv termin): beteendevetenskap',15],['Valfri kurs',15]]),
      row(6,'Fördjupning i sociologisk och socialpsykologisk teori',7.5),row(6,'Fördjupning i vetenskaplig metod',7.5),row(6,'Självständigt arbete inom beteendevetenskapligt program',15)
    ]
  }
};
