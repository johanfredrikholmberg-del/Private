...
function guide(){if(!active()||window.__studielotsDemoGuide)return;window.__studielotsDemoGuide=true;const seen=new Set();const copy={opportunities:['1 av 3','Här ser du flera möjliga vägar','Exempelmeriterna omfattar 150 hp. Procentsatserna här visar preliminär matchning mot generella examenskrav, inte hur många hp som kan räknas av från ett visst program. Välj lärosäte och program för att se programmets kursbaserade beräkning.'],planner:['2 av 3','Det här är Planeraren','Här visas preliminär avräkning mot det valda programmets kurser. Endast redan direkt matchade kurser och tillgodoräknanden med Starkt underlag räknas av. Gott eller begränsat underlag och historiska bifall ger ingen ytterligare avräkning. Lärosätet beslutar om tillgodoräknande.']};
