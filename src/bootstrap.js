...
{name:'post-processing',scripts:['/src/core/match-consistency.js?v=7','/src/features/planner/planner-summary.js?v=4','/src/features/planner/route-clarity.js?v=2','/src/ui/loading/loading-overlay.js?v=6','/src/features/demo/demo.js?v=6']}
];
