...
{name:'page-controllers',scripts:['/src/pages/programs/controller.js?v=9','/src/pages/studies/controller.js?v=1','/src/pages/opportunities/controller.js?v=2','/src/pages/planner/controller.js?v=2']},
{name:'app-runtime',scripts:['/src/app/runtime.js?v=18']},
{name:'post-processing',scripts:['/src/core/match-consistency.js?v=6','/src/features/planner/planner-summary.js?v=4','/src/features/planner/route-clarity.js?v=2','/src/ui/loading/loading-overlay.js?v=6','/src/features/demo/demo.js?v=6']}
];
