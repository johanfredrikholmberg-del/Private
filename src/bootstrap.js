...
{name:'fast-route',scripts:['/src/features/fast-route/fast-route-v3.js?v=1','/src/features/fast-route/programme-start-bridge.js?v=1','/src/features/fast-route/provisional-plan.js?v=1']},
...
{name:'post-processing',scripts:['/src/core/match-consistency.js?v=7','/src/core/fast-route-credit-consistency.js?v=1','/src/features/opportunities/subject-program-scores.js?v=1','/src/features/planner/planner-summary.js?v=4','/src/features/planner/route-clarity.js?v=2','/src/features/planner/evidence-details.js?v=1','/src/features/planner/evidence-colors.js?v=1','/src/features/fast-route/remaining-courses.js?v=1','/src/features/planner/fast-route-course-view.js?v=1','/src/ui/loading/loading-overlay.js?v=6','/src/features/demo/demo.js?v=6']}
];
