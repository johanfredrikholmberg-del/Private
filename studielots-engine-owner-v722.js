...
window.__studielotsEngine=Object.freeze({
 ...
 owned:[...locked],missing:[...missing]
});
window.__studielotsBuild={...(window.__studielotsBuild||{}),engineOwner:VERSION,engineOwnership:'single-owner-with-pure-engine-foundation'};
