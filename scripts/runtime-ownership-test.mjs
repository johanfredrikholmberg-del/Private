...
const required=['studielots-planner-controller-v721.js?v=721','studielots-planner-v800.js?v=800','studielots-fast-route-v804.js?v=804'];
const forbidden=['studielots-fast-route-v801.js','studielots-fast-route-v802.js?v=802','studielots-planner-runtime-v716.js','studielots-planner-ui-v647.js','studielots-planner-summary-v703.js','studielots-planner.js?v=690','studielots-planner-credit-visibility-v715.js','studielots-planner-handoff-v710.js','studielots-flow-v713.js','studielots-runtime-overlay-v706.js'];
...
console.log('Planner ownership OK: v800 + fast-route v804; verified standalone offerings may accelerate while unverified/program-only offerings may not.');
