...
const renderer=fs.readFileSync('studielots-planner-v806.js','utf8');
...
const required=['studielots-planner-controller-v721.js?v=721','studielots-planner-v806.js?v=806','studielots-fast-route-v804.js?v=804','studielots-fast-access-v805.js?v=805'];
const forbidden=['studielots-planner-v800.js?v=800','studielots-fast-route-v801.js','studielots-fast-route-v802.js?v=802','studielots-fast-access-v803.js?v=803','studielots-planner-runtime-v716.js','studielots-planner-ui-v647.js','studielots-planner-summary-v703.js','studielots-planner.js?v=690','studielots-planner-credit-visibility-v715.js','studielots-planner-handoff-v710.js','studielots-flow-v713.js','studielots-runtime-overlay-v706.js'];
...
if((loader.match(/studielots-planner-v806\.js\?v=806/g)||[]).length!==1)throw new Error('Expected one planner renderer');
...
if(!loader.includes("plannerRenderer:'planner-v806'"))throw new Error('Loader audit must identify planner v806');
...
if(!renderer.includes("const VERSION='806'"))throw new Error('Unexpected planner renderer version');
if(!renderer.includes("root.id='plannerV2Root'"))throw new Error('Planner v806 must own a dedicated root');
if(!renderer.includes('data-view="fast"'))throw new Error('Planner v806 must keep explicit fast-route CTA');
if(!renderer.includes('data-summary'))throw new Error('Planner v806 must include compact summary control');
if(!renderer.includes("plannerDesign:'mobile-reference-v806'"))throw new Error('Planner v806 design marker missing');
...
console.log('Planner ownership OK: v806 mobile design + fast-route v804 + fast-access v805; premium boundary and isolated renderer are guarded.');
