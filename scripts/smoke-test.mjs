...
const [html, css, app, runtime, manifest] = await Promise.all([
  ...
  readFile(new URL('../studielots-v615.js', import.meta.url), 'utf8'),
  readFile(new URL('../studielots-runtime-v615.js', import.meta.url), 'utf8'),
  readFile(new URL('../manifest.webmanifest', import.meta.url), 'utf8'),
]);

assert.match(html, /studielots-v615\.css\?v=615/);
assert.match(html, /studielots-v615\.js\?v=615/);
assert.match(html, /studielots-runtime-v615\.js\?v=615/);
assert.doesNotMatch(html, /pdf\.min\.mjs/);
assert.match(app, /async function loadPdfJs\(\)/);
assert.match(runtime, /const VERSION='615'/);
...
assert.match(app, /version:'v615'/);
assert.match(app, /programSearchRuntime='615'/);
