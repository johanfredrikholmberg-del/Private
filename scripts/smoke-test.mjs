...
const [html, css, catalog, app, runtime, manifest] = await Promise.all([
  ...
  readFile(new URL('../studielots-v616.js', import.meta.url), 'utf8'),
  readFile(new URL('../studielots-runtime-v616.js', import.meta.url), 'utf8'),
  readFile(new URL('../manifest.webmanifest', import.meta.url), 'utf8'),
]);

assert.match(html, /studielots-v615\.css\?v=615/);
assert.match(html, /studielots-catalog-v616\.js\?v=616/);
assert.match(html, /studielots-v616\.js\?v=616/);
assert.match(html, /studielots-runtime-v616\.js\?v=616/);
...
assert.match(runtime, /const VERSION='616'/);
...
assert.match(app, /version:'v616'/);
assert.match(app, /programSearchRuntime='616'/);
assert.match(runtime, /data-sl616-program/);
