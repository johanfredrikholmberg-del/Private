...
if(x){
 ...
 x.rows=[r(1,'Makroekonomi',7.5),r(1,'Grundläggande marknadsföring',7.5),r(1,'Mikroekonomi',7.5),r(1,'Organisering och ledning',7.5),r(2,'Statistik I',7.5),r(2,'Redovisningens grunder och tekniker',7.5),r(2,'Internationell ekonomi',7.5),r(2,'Ekonomistyrning I',7.5),r(3,'Affärsjuridik I',15),r(3,'Externredovisning',7.5),r(3,'Finansiell ekonomi',7.5),r(4,'Strategisk marknadsföring',7.5),r(4,'Organisationsdesign och managementrecept',7.5),r(4,'Statistik II',7.5),r(4,'Finansiell planering',7.5),track(5,[m5,k5,r5]),track(6,[m6,k6,r6]),track(7,[m7,k7,r7]),track(8,[{track:'Management',hp:30,courses:[['Självständigt arbete för civilekonomexamen, management',30]]},{track:'Marknadsföring',hp:30,courses:[['Självständigt arbete för civilekonomexamen, marknadsföring',30]]},{track:'Redovisning',hp:30,courses:[['Självständigt arbete för civilekonomexamen, redovisning',30]]}])];
 x.coverage='choice-required';x.reason='official-plan-verified-complete-four-year-track-structure';x.termSums={1:30,2:30,3:30,4:30,5:30,6:30,7:30,8:30};x.sourceEvidenceUrl='https://kursinfodoc.hb.se/PdfMaker.aspx?code=ACEKO&language=SV&revision=18%2C20&type=program';x.verifiedProgrammeOverride=true;x.trackContinuityRequired=true;x.tracks=['Management','Marknadsföring','Redovisning'];x.checkedAt=new Date().toISOString();
}
