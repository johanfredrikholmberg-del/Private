...
(async()=>{
  try{
    await load('/studielots-historical-credit-karlstad-2026-p1.js?v=711','data-sl-historical-karlstad-1');
    await load('/studielots-historical-credit-karlstad-2026-p2.js?v=711','data-sl-historical-karlstad-2');
    await load('/studielots-historical-credit-karlstad-2026-p3.js?v=711','data-sl-historical-karlstad-3');
    await load('/studielots-credit-policy-v709.js?v=711','data-sl-credit-policy');
    await load('/studielots-credit-info-v710.js?v=711','data-sl-credit-info');
    await load('/studielots-demo-karlstad-v711.js?v=711','data-sl-demo-karlstad');
