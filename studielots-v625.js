...
(async()=>{
  try{
    await load('/studielots-historical-credit-karlstad-2026-p1.js?v=707','data-sl-historical-karlstad-1');
    await load('/studielots-historical-credit-karlstad-2026-p2.js?v=707','data-sl-historical-karlstad-2');
    await load('/studielots-historical-credit-karlstad-2026-p3.js?v=707','data-sl-historical-karlstad-3');
    await load('/studielots-credit-policy-v707.js?v=707','data-sl-credit-policy');
