...
async function resolveName(req){
  ...
  url.searchParams.set('university',clean(req.query?.university)||'Göteborgs universitet');
...
export default async function handler(req,res){
  ...
  }catch(error){console.warn('gu-program-structure-v702 metadata',error)}
  return guHandler(req,res);
}
