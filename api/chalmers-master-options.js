...
const OPTIONS={
  ...
  TKELT:[
    ...
    {code:'MPEES',name:'Inbyggda elektroniksystem',eligibility:'direct',accredited:true,priority:true},
    {code:'MPTSE',name:'Industriell ekologi',eligibility:'direct',accredited:true},
    {code:'MPCAS',name:'Komplexa adaptiva system',eligibility:'direct',accredited:true},
    {code:'MPSOV',name:'Ljud och vibrationer',eligibility:'direct',accredited:true},
    {code:'MPENM',name:'Matematik och beräkningsvetenskap',eligibility:'direct',accredited:false},
    {code:'MPNAT',name:'Nanoteknologi',eligibility:'direct',accredited:true}
  ],
  TKMSK:[
    {code:'MPTSE',name:'Industriell ekologi',eligibility:'direct',accredited:true,priority:true},
    {code:'MPCAS',name:'Komplexa adaptiva system',eligibility:'direct',accredited:true},
  ...
  TKATK:[
    ...
    {code:'MPTSE',name:'Industriell ekologi',eligibility:'direct',accredited:true,priority:true,degree:'civil-engineering'},
    {code:'MPCAS',name:'Komplexa adaptiva system',eligibility:'direct',accredited:true,priority:true,degree:'civil-engineering'},
    {code:'MPSOV',name:'Ljud och vibrationer',eligibility:'direct',accredited:true,priority:true,degree:'civil-engineering'}
  ]
};
