...
async function boot(){
 ...
 await script('/studielots-planner-handoff-v710.js?v=720',{studielotsPlannerHandoff:'720'});
 await script('/studielots-flow-v713.js?v=720',{studielotsFlow:'720'});
 await script('/studielots-planner-runtime-v716.js?v=719',{studielotsPlannerRuntime:'719'});
 window.__studielotsBaseline={version:BASELINE,screenRepair:'712',core:'624',runtime:'706',responsive:'707',masterSelector:'684',autoStructure:'701',officialSource:'704',universityPaths:'720',studiesCompact:'716',plannerHandoff:'720',flow:'720',plannerRuntime:'719',loaded:[...loaded],failed:[...failed]};
 window.__studielotsLoaderAudit={version:BASELINE,ok:failed.length===0,failed:[...failed],removedLegacyPlannerModules:['planner-ui-700','planner-summary-703','planner-690','planner-credit-visibility-715']};
