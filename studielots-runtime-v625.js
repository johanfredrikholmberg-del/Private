(()=>{
'use strict';
const VERSION='654',CORE='/studielots-runtime-core-v641.js?v=641',UI='/studielots-planner-ui-v647.js?v=652',GUARD='/studielots-planner-guard-v653.js?v=654',SNAPSHOT='studielots_planner_snapshot',ORIGIN='studielots_planner_origin';
let busy=false;
...
function loadGuard(){if(document.querySelector('script[data-studielots-planner-guard="654"]'))return;const g=document.createElement('script');g.src=GUARD;g.async=false;g.dataset.studielotsPlannerGuard='654';document.body.appendChild(g)}
