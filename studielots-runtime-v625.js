(()=>{
'use strict';
const VERSION='645',CORE='/studielots-runtime-core-v641.js?v=641',SNAPSHOT='studielots_planner_snapshot',ORIGIN='studielots_planner_origin';
let busy=false;
