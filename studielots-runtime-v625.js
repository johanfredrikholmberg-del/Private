...
async function boot(){
 ...
 await script('/studielots-engine-owner-v722.js?v=733',{studielotsEngineOwner:'733'});
 ...
 window.__studielotsBaseline={version:BASELINE,screenRepair:'712',core:'624',runtime:'706',responsive:'707',masterSelector:'684',autoStructure:'701',officialSource:'704',universityPaths:'720',pureEngine:'732',engineOwner:'733',studiesCompact:'716',plannerController:'721',plannerRuntime:'719',loaded:[...loaded],failed:[...failed]};
 window.__studielotsLoaderAudit={version:BASELINE,ok:failed.length===0,failed:[...failed],singleOwners:{degreeEngine:'engine-owner-733',pureEngine:'engine-v1-732',plannerRenderer:'planner-runtime-719',plannerHandoff:'planner-controller-721'},shadowMode:{degreeEngine:true,diagnostics:true,classified:true,parityGate:true,uiTakeover:false},engineFixes:{emptySubjectFalsePositive:true,progressionClassification:true,levelFieldProgression:true,thesisClassification:true,exactSubjectMatching:true},removedLegacyPlannerModules:['planner-ui-700','planner-summary-703','planner-690','planner-credit-visibility-715','planner-handoff-720','flow-720']};
