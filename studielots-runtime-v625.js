...
async function boot(){
 ...
 await script('/studielots-engine-v1.js?v=731',{studielotsPureEngine:'731'});
 ...
 window.__studielotsBaseline={version:BASELINE,screenRepair:'712',core:'624',runtime:'706',responsive:'707',masterSelector:'684',autoStructure:'701',officialSource:'704',universityPaths:'720',pureEngine:'731',engineOwner:'727',studiesCompact:'716',plannerController:'721',plannerRuntime:'719',loaded:[...loaded],failed:[...failed]};
 window.__studielotsLoaderAudit={version:BASELINE,ok:failed.length===0,failed:[...failed],singleOwners:{degreeEngine:'engine-owner-727',pureEngine:'engine-v1-731',plannerRenderer:'planner-runtime-719',plannerHandoff:'planner-controller-721'},shadowMode:{degreeEngine:true,diagnostics:true,classified:true},engineFixes:{emptySubjectFalsePositive:true,progressionClassification:true,levelFieldProgression:true,thesisClassification:true},removedLegacyPlannerModules:['planner-ui-700','planner-summary-703','planner-690','planner-credit-visibility-715','planner-handoff-720','flow-720']};
