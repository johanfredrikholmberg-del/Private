...
window.__studielotsBuild={...(window.__studielotsBuild||{}),plannerConsistencyGuard:VERSION,ordinaryPlanLocked:true,fastRouteSeparated:true,hpConsistencyGuard:true,staleScheduleGuard:true,remainingTermCountFixed:true,completedTermsMarked:true};
