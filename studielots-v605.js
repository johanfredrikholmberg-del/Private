...
function render(){
 ...
 const html=`<div class="sl-dr-head"><div><h3>Distansväg</h3><div class="sl-dr-sub">En sammanhängande väg byggd enbart av kurser som är markerade som distans i underlaget.</div></div><span class="sl-dr-badge">${esc(badge)}</span></div>${body||'<div class="sl-dr-empty">Ingen verifierad distanskurs hittades ännu.</div>'}<div class="sl-dr-note">${esc(note)}</div>`;
